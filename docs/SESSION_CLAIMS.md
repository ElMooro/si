...
|---|---|---|---|
| earnings v1.1: universe join (sector/industry/mcap/cap-bucket via proven data/universe.json bind) + by-bucket beat stats + page bucket filters | 4882-4883 | S-fable-A2 | 2026-08-18 01:2x |

...
function mutablePublication(path) {
  ...
  return ['report.json', 'report-measurements.json', 'khalid-adaptive.json', 'risk-regime.json', 'jsi.json', 'jsi-history.json', 'jsi-calibration.json',
    ...
    'crisis-composite.json', 'defcon.json', 'crisis-composite-history.json', 'crisis-plumbing.json', 'market-internals.json', 'aaii-sentiment.json', 'credit-stress.json', 'vol-surface.json',

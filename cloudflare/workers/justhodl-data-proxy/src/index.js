...
function mutablePublication(path) {
  ...
  return ['report.json', 'report-measurements.json', 'khalid-adaptive.json', 'risk-regime.json', 'jsi.json', 'jsi-history.json', 'jsi-calibration.json',
    ...
    'crisis-composite.json', 'defcon.json', 'crisis-composite-history.json', 'crisis-plumbing.json', 'market-internals.json', 'aaii-sentiment.json', 'credit-stress.json', 'vol-surface.json', 'eurodollar-stress.json', 'insider-aggregate.json', 'capitulation.json', 'market-extremes.json', 'vrp.json',
    ...
    /^(?:insider-research|eurodollar-research|extremes-research|vrp-research)\/requests\/[a-f0-9]{64}\.json$/.test(key) ||

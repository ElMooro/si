...
function mutablePublication(path) {
  ...
  if (['dollar-radar.json', 'cross-asset-flow-state.json', 'gold-equity-rotation.json', 'dark-pool.json', 'finra-short.json', 'short-pressure.json'].includes(key)) return true;

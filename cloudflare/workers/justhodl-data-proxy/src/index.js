...
function mutablePublication(path) {
  ...
  return ['report.json', 'report-measurements.json', 'khalid-adaptive.json',
    ...
    'quantum-desk.json', 'quantum-desk-history.json', 'liquidity-inflection.json', 'eurodollar-plumbing.json', 'yen-carry.json', 'carry-surface.json', 'capital-inflows.json', 'foreign-flows.json', 'tic-flows.json', 'official-pulse.json', 'etf-true-flows.json', 'global-flow-desk.json', 'holdings-research.json',

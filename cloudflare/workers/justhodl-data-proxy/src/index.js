...
function mutablePublication(path) {
  ...
  return ['report.json', 'report-measurements.json', 'khalid-adaptive.json',
    ...
    'liquidity-inflection-decisive-call.json', 'global-liquidity.json', 'global-liquidity-history.json', 'cb-injection.json', 'alpha-compass.json', 'alpha-brief.json', 'alpha-brief.md', 'hot-money.json', 'hot-money-research/ledger.json', 'providers/twse/bfi82u-foreign.json', 'providers/tpex/insti-foreign.json'].includes(key) ||

...
function mutablePublication(path) {
  ...
  return ['report.json', 'report-measurements.json', 'khalid-adaptive.json', 'risk-regime.json', 'jsi.json', 'jsi-history.json', 'jsi-calibration.json',
    ...
    /^(?:insider-research|eurodollar-research|extremes-research|vrp-research|retail-research|valuation-research|tail-research|implied-research|fedwatch-research|fomc-research|cycle-research|nowcast-research|activity-research|sector-research|sector-tilt-research)\/requests\/[a-f0-9]{64}\.json$/.test(key) ||

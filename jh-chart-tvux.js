...
(function () {
  ...
  css.textContent = [
    ...
    ".tv-symwrap{background:#131722}",
    "html[data-theme=light] .tv-symwrap{background:#ffffff}",
    "html[data-theme=light] .tv-symchip,html[data-theme=light] .tv-iconbtn{background:#fff;border-color:#e0e3eb;color:#131722}",

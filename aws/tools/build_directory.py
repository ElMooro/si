...
CATEGORIES = [
    ...
    ("🌪", "Stress, Crisis & Risk",
     ...
     ["crisis", "stress", "defcon", "risk", "auction-crisis",
    ...
    ("💹", "Equities, Screening & Value",
     ...
     ["screener/", "stock/", "stocks/", "deep-value", "fundamentals",
    ...
    ("🎯", "Signals & Alpha",
     ...
     ["signal-board", "signals", "signal-scorecard", "trading-signals",
      ...
      "conviction/", "edge", "opportunities", "ml-predictions",
    ...
    ("🧮", "Portfolio, Risk & Execution",
     "The book, position sizing, allocation and the trade journal.",
     ["portfolio", "portfolio-manager", "portfolio/", "pm-decision",
      "allocator", "position-sizer", "sizing", "sizing/", "trade-journal",
      "trades/", "watchlist"]),

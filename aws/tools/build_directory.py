...
CATEGORIES = [
    ...
    ("🌪", "Stress, Crisis & Risk",
     ...
     ["crisis", "stress", "global-stress", "gsi-calibration", "cds-monitor", "defcon", "risk", "auction-crisis",
      "market-extremes",
      "compound-signals", "fleet-health", "audit", "anomaly/"]),
    ("📈", "Macro & Economy",
     "Per-country regimes, the global cycle and the raw macro feeds.",
     ["global-macro", "econ-calendar", "global-cycle", "global-cycle/",
      "macro-data",
    ...
    ("📊", "Rates, Bonds & Credit",
     ...
     ["bonds", "yield-curve", "dxy", "dollar", "cross-asset", "cross-asset-rv",
    ...
    ("🧮", "Portfolio, Risk & Execution",
     ...
     ["risk-desk", "portfolio", "portfolio-manager", "portfolio/",
      ...
      "firm-risk-board", "tail-hedge", "hedge-planner", "hedge-pnl",
      "allocator",
      "position-sizer",
      "sizing", "sizing/", "trade-journal", "trades/", "watchlist"]),
    ("📉", "Volatility & Market Internals",
     "Vol regime, the VIX curve and market-internals breadth.",
     ["vol", "vol-radar", "vrp", "vol-regime", "volatility", "vix-curve",
      "vix/",
...
LABELS = {
    ...
    "vrp": "Volatility Risk Premium \u2014 Implied vs Realized",
    "vol-radar": "Volatility Turning-Point Radar \u2014 Spike & Peak Canaries",
    "market-extremes": "Market Cycle Extremes \u2014 Tops & Capitulation",
    "dollar": "Dollar Radar \u2014 Pump/Dump Canaries & FRED Dollar Family",
    "global-stress": "Global Stress Matrix \u2014 World Equity & Bond Stress",
    "gsi-calibration": "GSI Calibration \u2014 Empirical IC vs Forward Drawdown",
    "chart-patterns": "Chart Pattern Scanner \u2014 200-DMA Crosses & Double Tops/Bottoms",
    "econ-calendar": "Economic Calendar \u2014 Releases & Consensus",
    ...
    "hedge-planner": "Hedge Planner \u2014 Execution Ticket",
    "hedge-pnl": "Hedge Overlay Scorecard \u2014 Earning Its Carry?",

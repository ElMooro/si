...
def artifacts():
    ...
    return {
        ...
        "data/global-business-cycle.json": {"generated_at": ts(20), "aggregate": {"global_phase": "GLOBAL_EXPANSION", "global_avg_cli": 100.6, "cli_level": 100.6},
                                            "downturn_probability_6m": 0.18, "fresh_count": 30, "n_countries": 34},
        ...
        "data/etf-flows.json": {"generated_at": ts(4), "by_etf": {"SPY": {"ticker": "SPY", "dvol_z_score": 2.4, "return_1d_pct": 0.8, "flow_signal": "HEAVY_INFLOW", "aum_b": 600.0, "today_dollar_vol_b": 40.0},
                                                                  ...
                                                                  "SMH": {"ticker": "SMH", "dvol_z_score": None}}},
        ...
        "data/fortress.json": {"generated_at": ts(12), "board": [{"ticker": "GOOGL", "tier": "COILED", "composite": 66.0, "conviction": 58.0, "asymmetry": 3.1, "gates_passed": 5, "coil_state": "COILING", "sector": "Communication Services", "industry": "Internet Content & Information", "resilience_confidence": 0.8, "cap_bucket": "mega"},
        ...
        "data/catalyst.json": {"generated_at": ts(9), "by_ticker": {"AMZN": {"score": 4.2, "catalysts": [{"class": "contract_win", "evidence": "AWS $2B DoD contract", "src": "pr", "weight": 2.2}, {"class": "guidance_raise", "evidence": "raised FY", "src": "pr", "weight": 2.0}]},

...
rc = 0
for name in ('test_factory.py', 'test_discipline.py', 'test_gear_b_own.py', 'test_audit_fixes.py', 'test_owned_inference.py', 'test_learning_seam.py', 'test_wall_ledger.py', 'test_code_verify.py'):
    try:

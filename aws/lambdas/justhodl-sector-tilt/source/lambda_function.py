...
from sector_tilt_model import CONTRACT
from sector_tilt_store import CURRENT,reader,run
PUBLISHED_KEY='data/sector-tilt.json'
if CURRENT!=PUBLISHED_KEY:raise ValueError('Sector tilt publication route drift')

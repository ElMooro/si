...
class ReportStoreTests(unittest.TestCase):
    ...
    def test_real_research_handler_does_not_enter_legacy_path(self):
        ...
        from inflection_research_catalog import extend_catalog as inflection_catalog,SERIES as INFLECTION_SERIES
        ...
        from activity_source_catalog import extend_catalog as activity_catalog,SERIES as ACTIVITY_SERIES
        from dollar_source_catalog import extend_catalog as dollar_catalog,SERIES as DOLLAR_SERIES
        ...
        env={'time':store.time,'json':json,'track_errors':lambda fn:fn,'s3':object(),'S3_BUCKET':'b','FRED_KEY':'private',
             ...
             'include_activity_series':activity_catalog,
             'include_dollar_series':dollar_catalog,
        ...
        self.assertTrue(set(ACTIVITY_SERIES)<=set(calls[0][0]))
        self.assertTrue(set(DOLLAR_SERIES)<=set(calls[0][0]))

...
REG = {
 ...
 # ---- ops 5581 (2026-09-15): every keyed/major provider the fleet actually calls is a catalog entry (add-only).
 # Key facts (SSM paths, hashes) live in docs/DATA_PROVIDERS.md + data/ops/provider-keys-<date>.json; never here.
 "fmp": {"name": "FMP — Financial Modeling Prep (Ultimate)",
  "api": "financialmodelingprep.com/stable",
  "engines": ["justhodl-stock-buying", "justhodl-buyback-engine", "justhodl-earnings-sentiment", "justhodl-coffee-can",
              "justhodl-magic-formula", "justhodl-gf-value", "justhodl-etf-census", "justhodl-fi-census", "justhodl-merger-arb",
              "justhodl-ipo-pipeline", "justhodl-ignition", "justhodl-index-inclusion", "justhodl-hiring-velocity",
              "justhodl-investor-agents", "justhodl-stock-ai-research", "benzinga-news-agent", "equity_enrich consumers"],
  "prefixes": ["data/warm/fmp/", "data/providers/fmp/"],
  "hot": ["data/fmp-ratios.json", "data/industry-boom.json", "data/share-flows.json", "data/coffee-can.json",
          "data/magic-formula.json", "data/gf-value.json", "data/merger-arb.json", "data/ipo-pipeline.json"],
  "cadence": "EOD_TTM / FILING", "label": "FMP EOD/TTM — never LIVE"},
 "openfigi": {"name": "OpenFIGI — symbology (FIGI / share-class FIGI)",
  "api": "api.openfigi.com/v3/mapping",
  "engines": ["justhodl-symbology-master", "justhodl-13f-positions (CUSIP second resolver)"],
  "prefixes": ["data/symbology/"], "hot": ["data/symbology/master.json"],
  "label": "FIGI only — never CUSIP/ISIN from OpenFIGI"},
 "cryptoquant": {"name": "CryptoQuant — BTC/ETH on-chain",
  "api": "api.cryptoquant.com/v1",
  "engines": ["justhodl-cryptoquant", "justhodl-crypto-intel", "chart On-chain desk"],
  "prefixes": ["data/warm/cryptoquant/"],
  "hot": ["data/cryptoquant-onchain.json", "data/cryptoquant-series.json", "data/history/cryptoquant.json"],
  "cadence": "EOD", "label": "CryptoQuant EOD on-chain — never LIVE"},
 "coinbase": {"name": "Coinbase Exchange — BTC tape + official prints",
  "api": "api.exchange.coinbase.com",
  "engines": ["justhodl-coinbase-premium", "factory official prints (wall)"],
  "prefixes": ["data/warm/coinbase/"], "hot": ["data/coinbase-premium.json", "data/coinbase-premium-history.json"]},
 "eia": {"name": "EIA — US Energy Information Administration",
  "api": "api.eia.gov/v2",
  "engines": ["justhodl-grid-queue", "justhodl-real-economy-collector"],
  "prefixes": ["data/warm/eia/"], "hot": ["data/eia-energy.json"]},
 "finra": {"name": "FINRA — short volume / margin (no client secret)",
  "api": "api.finra.org",
  "engines": ["justhodl-finra-full", "legacy short-volume engines"],
  "prefixes": ["data/warm/finra-full/"], "hot": ["data/finra-short.json", "data/finra-short-history.json"]},
 "benzinga": {"name": "Benzinga — earnings calendar (sunsets 2026-10-10; FMP shim)",
  "api": "api.benzinga.com",
  "engines": ["benzinga-news-agent"],
  "prefixes": [], "hot": ["data/benzinga-earnings-calendar.json", "data/benzinga-earnings.json"]},
 "quiver": {"name": "Quiver Quant — congress / lobbying / off-exchange",
  "api": "api.quiverquant.com",
  "engines": ["quiver caches"],
  "prefixes": [], "hot": ["data/quiver-congress-cache.json", "data/quiver-lobbying-cache.json"]},
 "tradingview": {"name": "TradingView — notes + vault bars",
  "api": "tradingview.com (session ingest)",
  "engines": ["justhodl-tvnotes", "tv-vault lanes"],
  "prefixes": ["data/warm/tv-bars/", "data/warm/tv-vault/"], "hot": ["data/tradingview.json", "data/tradingview-notes.json"]},
 "coingecko": {"name": "CoinGecko — crypto reference prices", "api": "api.coingecko.com/api/v3",
  "engines": ["crypto lanes"], "prefixes": [], "hot": []},
 "deribit": {"name": "Deribit — DVOL / crypto options", "api": "www.deribit.com/api/v2",
  "engines": ["crypto vol lanes"], "prefixes": [], "hot": []},
 "cmc": {"name": "CoinMarketCap — listings", "api": "pro-api.coinmarketcap.com",
  "engines": ["crypto listing lanes"], "prefixes": [], "hot": []},
 "alphavantage": {"name": "Alpha Vantage — quotes fallback", "api": "www.alphavantage.co",
  "engines": ["legacy quote fallbacks"], "prefixes": [], "hot": []},
 "newsapi": {"name": "NewsAPI — headlines", "api": "newsapi.org/v2",
  "engines": ["news lanes"], "prefixes": [], "hot": []},
 "nasdaq-datalink": {"name": "Nasdaq Data Link", "api": "data.nasdaq.com/api/v3",
  "engines": ["datalink lanes"], "prefixes": [], "hot": []},
 "perplexity": {"name": "Perplexity — research voice (LLM, not data)", "api": "api.perplexity.ai",
  "engines": ["research voice"], "prefixes": [], "hot": []},

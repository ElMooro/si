"""
VENDORED COPY of justhodl-auction-crisis-detector (scoring functions only are used by
justhodl-auction-desk to rebuild the 1996->today composite history with the same math).

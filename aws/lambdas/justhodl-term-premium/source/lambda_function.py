"""Native original-workbook ACM research; public access is read-only."""
import json,os
import boto3
from botocore.config import Config
from term_premium_store import run,qualified_arithmetic
from term_premium_model import CONTRACT,CURRENT

...
STAMP='2026-09-20T22:05:00+00:00';AT=datetime.fromisoformat(STAMP)
...
def fixture():
 ...
 inputs={'contract':'implied-native-inputs.v1','generated_at':STAMP,'macro':store.snapshot(client,'b',store.SOURCES[0]),

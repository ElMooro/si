...
PUBLISHED_KEY='data/short-pressure.json'
...
def lambda_handler(event=None,context=None):
    ...
    result=reference.run(client,BUCKET,event.get('request_id') or event.get('id') or 'scheduled-short-volume-reference:'+datetime.now(timezone.utc).date().isoformat(),execution)

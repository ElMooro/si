...
def lambda_handler(event, context):
    ...
    for reg in REGISTRY:
        ...
        score = __import__("gsi_authority").qualified_score(d) if reg["name"] == "global_stress" else __import__("crisis_authority").qualified_score(d) if reg["name"] == "crisis_composite" else __import__("eurodollar_research").qualified_score(d) if reg["name"] == "eurodollar_stress" else deep_get(d, reg["score_path"])
    ...
    for reg in REGISTRY:
        ...
        if name in ("global_stress", "crisis_composite", "eurodollar_stress"):

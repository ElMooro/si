...
suite.addTests(unittest.TestLoader().loadTestsFromName('test_capital_research_boundary.Tests.test_flow_annotations_require_actual_components_and_both_revisions'))

...
with patch.dict(sys.modules,{'boto3':types.SimpleNamespace(client=lambda *a,**k:None),
    ...
    spec=importlib.util.spec_from_loader('yield_curve_test',__import__('importlib.machinery',fromlist=['SourceFileLoader']).SourceFileLoader('yield_curve_test',str(ROOT/'tests/fixtures/legacy-yield-curve-before-native.py.txt')))

...
REQUEST='chatgpt-ops-6015-futures-native-candidate'
...
def main():
    ...
    with report('ops_6015_futures_parallel_native_candidate') as r:
        ...
        compiled=store.materialize(s3,BUCKET,inputs,read)
        ...
        r.kv(candidate_seconds=elapsed,peak_rss_kib=resource.getrusage(resource.RUSAGE_SELF).ru_maxrss)

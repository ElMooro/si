...
REQUEST='chatgpt-accounting-completed-replay-acceptance-6108'
...
def main():
    subprocess.run([sys.executable,str(ROOT/'tests/test_statement_delivery_acceptance.py')],cwd=ROOT,check=True)
    client=boto3.client('s3',region_name='us-east-1');bucket=capture.BUCKET
    with report('ops_6108_accounting_completed_replay_acceptance') as r:
        ...
        progress={'request_id':REQUEST,'status':'claimed','replay':prior.REFERENCE,
            ...
            'original_replay_source_commit':'577be62b6bae7b244c96b614f5d922687f458477'}
        ...
        try:
            ...
            result={'source_workflow_run':36157251200,'replay':prior.REFERENCE,'qualification':previous['qualification'],
                'stages':previous['stages'],'completed_replay_journal':progress['whole_failed_journal'],
                'complete_original_replay_verified':True,'replay_repeated':False,'public_artifacts_checked':len(public),

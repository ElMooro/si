"""Alias-aware acceptance after 6045 stopped before invoking the native producer.

The failed report remains intact. Exact candidate, source commit and durable
producer request identity are unchanged; verified live schedules are recognized.
"""
...
def main():
    ...
    with report('ops_6047_offexchange_alias_aware_acceptance') as r:

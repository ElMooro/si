"""Qualify the stable-variance compiler from the accepted retained source inventory."""
...
BUCKET = base.BUCKET
REQUEST = 'chatgpt-short-volume-replay-candidate-6051'
...
def main():
    ...
    with report('ops_6051_short_volume_stable_variance_candidate') as r:

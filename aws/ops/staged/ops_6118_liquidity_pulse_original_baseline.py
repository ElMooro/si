"""Preserve native liquidity-pulse and replay its existing canonical FRED roots.
...
FUNCTION = 'justhodl-liquidity-pulse'
PRIVATE = 'audit-private/20260909-originals/liquidity-pulse-research/'
REQUEST = 'chatgpt-liquidity-pulse-original-baseline-6118'
...
INPUTS = ('data/liquidity-pulse.json', 'data/liquidity-credit-engine.json', 'data/report-measurements.json')
SERIES = ('WALCL', 'WRESBAL', 'WTREGEN', 'RESPPALGUONNWW', 'RESPPNTEPNWW', 'OTHL1690',
          'SWP1690', 'BAMLH0A3HYC', 'BAMLHE00EHYIOAS', 'BAMLEMHBHYCRPIOAS', 'HQMCB10YR')
...
def main():
    ...
    with report('ops_6118_liquidity_pulse_original_baseline') as r:
        progress = {'contract': 'liquidity-pulse-source-baseline.v1', 'request_id': REQUEST,
        ...
        try:
            ...
            paths = subprocess.check_output(['git', 'grep', '-l', '-F', 'liquidity-pulse.json', '--',
            ...
            access_ref = retain(s3, encoded({'contract': 'liquidity-pulse-baseline-access.v1', 'outcomes': outcomes}))

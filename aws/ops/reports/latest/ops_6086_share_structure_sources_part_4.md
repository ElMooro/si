...
**Status:** failure  
**Duration:** 4350.1s  
**Finished:** 2026-09-25T18:39:58+00:00  
...
Traceback (most recent call last):
  File "/home/runner/work/si/si/aws/ops/ops_report.py", line 98, in report
    yield r
  File "/home/runner/work/si/si/aws/ops/checks/share_structure_batch_runner.py", line 173, in main
  ...
  File "/opt/hostedtoolcache/Python/3.12.14/x64/lib/python3.12/concurrent/futures/thread.py", line 59, in run
    result = self.fn(*self.args, **self.kwargs)
             ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/home/runner/work/si/si/aws/ops/checks/share_structure_batch_runner.py", line 171, in deny

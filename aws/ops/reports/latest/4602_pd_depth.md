...
**Status:** failure  
**Duration:** 1004.7s  
**Finished:** 2026-08-11T18:17:48+00:00  
...
Traceback (most recent call last):
  File "/opt/hostedtoolcache/Python/3.12.13/x64/lib/python3.12/site-packages/botocore/httpsession.py", line 509, in send
...
Traceback (most recent call last):
  File "/home/runner/work/si/si/aws/ops/ops_report.py", line 97, in report
    yield r
  File "/home/runner/work/si/si/aws/ops/pending/ops_4602_pd_depth.py", line 89, in main
  ...
  File "/opt/hostedtoolcache/Python/3.12.13/x64/lib/python3.12/site-packages/botocore/endpoint.py", line 119, in make_request
    return self._send_request(request_dict, operation_model)
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/opt/hostedtoolcache/Python/3.12.13/x64/lib/python3.12/site-packages/botocore/endpoint.py", line 202, in _send_request
    while self._needs_retry(
          ^^^^^^^^^^^^^^^^^^
  File "/opt/hostedtoolcache/Python/3.12.13/x64/lib/python3.12/site-packages/botocore/endpoint.py", line 362, in _needs_retry
  ...
  File "/opt/hostedtoolcache/Python/3.12.13/x64/lib/python3.12/site-packages/botocore/endpoint.py", line 281, in _do_get_response
    http_response = self._send(request)
                    ^^^^^^^^^^^^^^^^^^^
  File "/opt/hostedtoolcache/Python/3.12.13/x64/lib/python3.12/site-packages/botocore/endpoint.py", line 385, in _send
...
botocore.exceptions.ReadTimeoutError: Read timeout on endpoint URL: "https://lambda.us-east-1.amazonaws.com/2015-03-31/functions/justhodl-nyfed-markets-full/invocations"

```

## Log
- `18:01:04` fred guard: scope=full_catalog ver=2.3.0 imported=110270 (untouched)
## 1. Settle v2, run one sync tranche

- `18:01:04`   live env: {'S3_BUCKET': 'justhodl-dashboard-live', 'PD_TRANCHE': '20'}
- `18:01:04` ✅   PD_TRANCHE -> 150 (stale live env corrected)
- `18:01:09`   before: hist_v=2 done=60 status=converging

# ops 3873 — GATE: served flows.html script vs LIVE production data

**Status:** failure  
**Duration:** 4.1s  
**Finished:** 2026-07-25T18:26:29+00:00  
...
- `18:26:25` ✅   66,734 bytes served
- `18:26:25` ✅   version marker JH_FLOWS_PRESSURE_3873 present — CDN matches this deploy
## 2. pull LIVE daily.json + constituent-pressure.json

- `18:26:26` ✅   daily.json 170,648 bytes · constituent-pressure.json 3,612,137 bytes

...
## Tier 2 — DELTA-ONLY after Khalid live-render audit 2026-07-12 (ops 3131): implied move / ATM IV /
## skew / P-C OI / IV smile ALREADY LIVE (Options-Implied Expectations block); earnings-surprise
## history ALREADY LIVE (Earnings Track Record). Build ONLY the deltas — never rebuild those.
#6 EARNINGS-VOL EDGE (DELTA ONLY: realized-vs-implied RICH/CHEAP verdict + PEAD drift): next earnings date + countdown (FMP /stable/ earnings calendar); options-implied move
...
#9 OPTIONS POSITIONING (DELTA ONLY: IV-rank-vs-own-1y ledger + term structure): IV rank vs own 1y REQUIRES a new daily IV ledger

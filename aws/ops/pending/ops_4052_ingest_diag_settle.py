"""ops_4052 — lift the watchlist cap, settle, verify Khalid's upload landed."""
import io
import json
import sys
import time
...
MARK = "ops4052: diag ships even at ZERO"


def main():
    with report("4052_ingest_diag_settle") as rep:
        ...
        for _ in range(24):
            ...
            if c.get("State") == "Active" and \
                ...
                if MARK in dep and "last_harvest_diag" in dep:
                    ok = True
                    break
            time.sleep(8)

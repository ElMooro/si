"""ops 4686 — arm the browser grabber + publish it ready-to-paste.
...
def main():
    with report("4686_arm_grabber") as r:
        r.heading("ops 4686 — re-arm grabber v2 (chart-independent)")
        misses = 0
        ...
        # 4686 rev: /justhodl/tvnotes/ingest-url does not exist —

"""Retry the complete core release using exact source checkout despite later observer commits. No AWS API calls."""
...
REPORT = ROOT / "aws/ops/reports/latest/ops_5236_core_recovery_dispatch.json"
...
def main():
    ...
    report = {"operation": "5236", "workflow": WORKFLOW, "workflow_sha": commit, "base_sha": BASE_SHA,
...
if __name__ == "__main__":
    ...
    with ops_report("ops_5236_retry_pinned_core_release") as rep:
        try:
            main()

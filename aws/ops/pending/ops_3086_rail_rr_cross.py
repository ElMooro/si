...
UA = {"User-Agent": "Mozilla/5.0 ops-3086",
...
def main():
    ...
    with report("3086_rail_rr_cross") as rep:
...
def _fin(rep, fails, warns):
    (AWS_DIR / "ops" / "reports" / "3086.json").write_text(json.dumps(
        {"ops": 3086, "verdict": "FAIL" if fails else "PASS",

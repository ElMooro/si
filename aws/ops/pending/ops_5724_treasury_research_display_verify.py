...
def main():
    ...
    with report('ops_5724_treasury_research_display_verify') as r:
        ...
        assert doc['version']=='1.4.0' and datetime.fromisoformat(doc['generated_at'].replace('Z','+00:00'))>=started

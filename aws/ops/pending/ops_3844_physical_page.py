"""
ops_3844 — edge-verify physical-trade.html + field coverage + portwatch untouched
...
def main():
    with report("3844_physical_page") as rep:
        rep.heading("ops 3844 — physical-trade.html live + portwatch untouched")
        ...
        need = [("divergence board", "Divergence board"),

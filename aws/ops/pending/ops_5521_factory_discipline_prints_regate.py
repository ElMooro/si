...
def main() -> int:
    ...
    head = _head()
    with report("ops_5521_factory_discipline_prints_regate") as R:
        R.heading("ops 5521 (re-arm of 5520) -- factory discipline in the tick + official prints lane: receipts, live ticks, dry-run prints, boundaries")
        R.kv(head=head[:10])

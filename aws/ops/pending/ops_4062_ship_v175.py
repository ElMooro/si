"""
ops_4062 — ship v1.5.0: rebuild the zip Khalid downloads, settle the
...
def main():
    with report("4062_ship_v175") as rep:
        rep.heading("ops 4016 — extension v1.7.5 + sources persistence")
        checks = []
        ...
        checks.append(("zip carries v1.5.0", man.get("version") == "1.7.5"))
        ...
        checks.append(("zip content is FULLY AUTONOMOUS",
                       "JUNK_RX" in cjs and "source_description" in cjs))

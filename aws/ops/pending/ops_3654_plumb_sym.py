"""ops 3654 — NEW justhodl-bis-crossborder (BIS WS_CBS_PUB foreign claims,
...
with report("3654_plumb_sym") as rep:
    rep.heading("ops 3654 — BIS cross-border claims engine + plumbing wire")
    out = {"gates": {}}
    fails = []
    ...
    Path("aws/ops/reports/3654.json").write_text(json.dumps(out, indent=2, default=str))
    sys.exit(0)

"""
ops_4014 — verify the central-bank expansion end to end: vault symbols LIVE
...
NEW = {"JPMB": (-25, 15), "JPM2YY": (-8, 15), "JPM3": (-8, 15),
       "JPTANKAN": (-60, 60), "JPCALLR": (-0.2, 2.5),
       "BRINTR": (5, 20), "BRFER": (200000, 500000), "BRLUSD": (3, 8),
       "FIIPYY": (-25, 30), "ESIPYY": (-25, 30), "ITIPYY": (-25, 30),
       "CHIPYY": (-25, 30), "KRIPYY": (-25, 30), "BRIPYY": (-25, 30),
       "IT10Y": (1, 8), "ES10Y": (1, 8), "FI10Y": (1, 8),
       "CH10Y": (-0.5, 4), "KR10Y": (1, 8), "CHINTR": (-1, 4),
       "KRINTR": (0, 8)}
...
def main():
    with report("4014_six_verify2") as rep:
        ...
        ok = settle("justhodl-domain-barometers",
                    "domain-barometers v1.4 ops4010 six-country",
                    None, rep)
        checks.append(("barometers v1.4 settled", ok))
        ...
        checks.append((">=15 new symbols carry a brain-note polarity", pol_ok >= 15))

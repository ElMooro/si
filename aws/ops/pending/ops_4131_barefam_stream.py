"""ops_4131 — streaming phase timeline: settle v3.15.4, invoke, watch the
...
MARK = "tradingview-vault v3.16.1 ops4131 bare-family"


def main():
    with report("4131_barefam_stream") as rep:

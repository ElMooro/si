"""
ops_3875 — PROBE: field-coverage audit of every field the etf-constituents
...
def main():
    with report("3875_pressure_field_coverage") as rep:
        rep.heading("ops 3875 — PROBE: field-coverage audit, new stock fields vs served flows.html")

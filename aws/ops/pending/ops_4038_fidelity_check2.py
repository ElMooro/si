"""ops_4038 — FULL CHECK v2: everything from 4034 PLUS note-fidelity —
...
MARK = "tv-workbench v1.1.1 ops4037 bare-union"
...
def main():
    with report("4038_fidelity_check2") as rep:
        ...
        for _i in range(12):
            ...
            if wb.get("marker") == MARK:
                rep.ok(f"  v1.1.1 artifact after ~{_i*15}s")
                break
            _t.sleep(15)
        checks.append(("workbench is v1.1.1 bare-union",
                       wb.get("marker") == MARK))

"""
ops_4050 — ship v1.5.0: rebuild the zip Khalid downloads, settle the
...
def main():
    with report("4050_ship_v173") as rep:
        rep.heading("ops 4016 — extension v1.7.3 + sources persistence")
        checks = []
        ...
        checks.append(("zip carries v1.5.0", man.get("version") == "1.7.3"))
        ...
        checks.append(("zip content is FULLY AUTONOMOUS",
                       "contentHarvest" in cjs and "DIAG" in cjs and "first_err" in cjs))

...
def main() -> int:
    ...
    with report("ops_5537_own_weights_restage") as R:
        R.heading("ops 5537 (restage) -- owned training lane: ECR repo, pinned recipe bundle, base-weight staging job (CPU, priced), no flip")
        R.kv(head=head[:10])

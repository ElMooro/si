"""ops_4120 — family verify-only: artifact truth or the vault's own logs."""
import json
import sys
...
def main():
    with report("4120_post_window") as rep:
        ...
        try:
            ev = logs.filter_log_events(
                ...
                filterPattern='?REPORT ?families ?timed ?Traceback ?tv-vault',
                limit=40)

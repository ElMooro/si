"""
ops_3876 — GATE: run the SERVED flows.html's own inline script, unmodified,
...
def main():
    with report("3876_pressure_feature_live_gate_recheck") as rep:
        rep.heading("ops 3876 — GATE: served flows.html script vs LIVE production data")

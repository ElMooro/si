...
lam=boto3.client("lambda",region_name="us-east-1",config=Config(read_timeout=90)); ROLE="arn:aws:iam::857687956942:role/lambda-execution-role"; FN="tmp-hub"
code=r'''
...
def lambda_handler(e,c):
    ...
    try:
        ...
        out["ecb_hub"]={"status":200,"bytes":len(h),
          "has_liquidity":"LIQUIDITY & BALANCE SHEET" in h,
          "has_rates":"POLICY RATES" in h,
          "has_signals":"DUMP-PREDICTOR SIGNALS" in h,
          "has_history":"FULL HISTORY (1997+)" in h,
          "not_old_openbb":"eurodollar stress: n/a" not in h}
...
open("aws/ops/reports/1506_hub.json","w").write(json.dumps(out,indent=2,default=str)); print("done")

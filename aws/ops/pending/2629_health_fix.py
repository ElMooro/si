...
dh=json.loads(s3.get_object(Bucket="justhodl-dashboard-live",Key="data/liquidity-inflection.json")["Body"].read()).get("data_health") or []
for d in dh: print(f"  {d['feed']}: {d['as_of']} ({d['age_days']}d, {d['status']})")
print("DONE 2629")

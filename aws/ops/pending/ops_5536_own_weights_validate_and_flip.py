"""ops 5536 -- owned weights validated, Gear B flipped to model_source=own (Claude, 2026-09-13).
...
def main() -> int:
    ...
    with report("ops_5536_own_weights_validate_and_flip") as R:
        R.heading("ops 5536 -- owned base weights: wait for staging, validate manifest + objects, flip Gear B to model_source=own")
        ...
        control = {**control_old, "schema_version": "gearb-control.v1", "enabled": True, "model_source": "own", "model_id": MODEL_ID,
                   ...
                   "season_id": control_old.get("season_id") or "season-2026-09-14", "written_by": "ops 5536", "previous_written_by": control_old.get("written_by"),

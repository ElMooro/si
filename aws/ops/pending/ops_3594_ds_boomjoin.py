"""ops 3594 — deal-scanner v3.2.1 display restore: sized-but-not-green deals
...
with report("3594_ds_boomjoin") as rep:
    rep.heading("ops 3594 — deal-scanner sized-cards + industry-peer context")
    out = {"gates": {}}
    fails = []
    ...
    Path("aws/ops/reports/3594.json").write_text(json.dumps(out, indent=2, default=str))
    sys.exit(0)

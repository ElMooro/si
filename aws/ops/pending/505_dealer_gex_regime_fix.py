#!/usr/bin/env python3
"""505 — Redeploy GEX v1.2.1 with regime + flip fixes, verify."""
import io, json, os, time as _time, zipfile, base64
from datetime import datetime, timezone
import boto3

REPORT = "aws/ops/reports/505_dealer_gex_regime_fix.json"
...
def main():
    ...
    try:
        lam.update_function_code(FunctionName=NAME, ZipFile=zip_source(SOURCE))

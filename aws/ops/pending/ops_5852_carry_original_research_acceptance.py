...
from carry_research import CONTRACT,CURRENT,PREFIX,encoded,digest
...
def main():
    expected=subprocess.check_output(['git','log','-1','--format=%H','--','aws/lambdas/justhodl-carry-surface/source/carry_store.py'],text=True).strip()
    ...
    with report('ops_5852_carry_original_research_acceptance') as r:

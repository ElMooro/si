"""ops_5182 -- auction desk v1.0.1: announced rows out of the bank (today = the latest
...
with report("ops_5182_auction_desk_v101") as R:
    R.heading("ops 5182 -- auction desk v1.0.1 verify")
    marker_ok = False
    for _ in range(40):
        c = lam.get_function_configuration(FunctionName=FN)
        lm = c.get("LastModified", "")
        if lm >= "2026-09-04T02:35" and c.get("LastUpdateStatus") in (None, "Successful"):
            marker_ok = True
            break
        time.sleep(15)

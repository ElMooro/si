...
def main():
    with report("3867_liq_overlay_truth") as rep:
        rep.heading("ops 3867 — liquidity overlay 0/25: stale feed, neutral regime, or defect")
        ...
        regime = liq.get("liquidity_regime") or liq.get("regime")
        score = liq.get("liquidity_score") or liq.get("score")

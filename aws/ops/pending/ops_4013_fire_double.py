"""
ops_4013 — INVOKE-ONLY. Enforce 900/3008, confirm the v1.6 marker is the
...
MARK = "tradingview-vault v3.10.1 ops4013 jpm3+2y"


def main():
    with report("4013_fire_double") as rep:
        ...
        rep.log("  pass-1 fired; sleeping 150s so pass-2 lands outside the FRED limiter")
        time.sleep(150)
        lam.invoke(FunctionName=FN, InvocationType="Event",
                   Payload=b'{"source": "ops4013-p2"}')

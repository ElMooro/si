"""Retry only Research Backtest after fixing its observed memory exhaustion. No AWS API calls."""
...
BASE_SHA = "fee895b944849ac6ae0d7d47359caaba1d653236"
WORKFLOW = "deploy-lambdas.yml"
REPORT = ROOT / "aws/ops/reports/latest/ops_5248_core_recovery_dispatch.json"
...
def main():
    ...
    report = {"operation": "5248", "workflow": WORKFLOW, "workflow_sha": commit, "base_sha": BASE_SHA,
...
if __name__ == "__main__":
    ...
    with ops_report("ops_5248_retry_pinned_core_release") as rep:
        try:
            main()

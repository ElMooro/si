...
UA = {"User-Agent": "Mozilla/5.0 ops-3083",
...
def main():
    ...
    with report("3083_rail_rr_cross") as rep:
...
def _fin(rep, fails, warns):
    (AWS_DIR / "ops" / "reports" / "3083.json").write_text(json.dumps(
        {"ops": 3083, "verdict": "FAIL" if fails else "PASS",

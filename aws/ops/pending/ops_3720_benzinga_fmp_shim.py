"""
ops 3720 — aws/shared/benzinga.py: FMP fallback for the dead Massive calendar
...
def main():
    with report("3720_benzinga_fmp_shim") as rep:
        rep.heading("ops 3720 — shared/benzinga.py FMP calendar fallback")
        out = {}
        hard_fail = []

"""ops 2807 — redeploy macro-leads code (FRED recency + Yahoo metals) + verify all blocks."""
...
def finish():
    ...
    json.dump(R,open("aws/ops/reports/2807_macro_leads_reverify.json","w"),indent=1,default=str)

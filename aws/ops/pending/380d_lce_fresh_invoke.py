#!/usr/bin/env python3
"""Step 380d — Invoke LCE + dump fresh output."""
import io, json, os, time, zipfile
from datetime import datetime, timezone
import boto3

REPORT = "aws/ops/reports/380d_lce_fresh_invoke.json"
NAME = "justhodl-tmp-lce-fresh"
...
def lambda_handler(event, context):
    ...
    out["invoke"] = {"status": resp.get("StatusCode"), "body": body[:300]}
    time.sleep(2)
    # Read fresh output
    ...
    for sid, info in d.get("series", {}).items():
        if info.get("available"):
            summary[sid] = {
                ...
                "latest_converted": info.get("latest_value"),
                "latest_raw": info.get("latest_value_raw"),

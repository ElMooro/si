...
def main() -> int:
    ...
    with report("ops_5528_own_training_lane") as R:
        R.heading("ops 5528 -- owned training lane: ECR repo, pinned recipe bundle, base-weight staging job (CPU, priced), no flip")
        R.kv(head=head[:10])
        ...
        try:
            ...
            R.ok("ECR justhodl/factory-train exists")
            ...
            R.ok("ECR justhodl/factory-train created (immutable tags, scan on push)")
        # 3. bundle + pin

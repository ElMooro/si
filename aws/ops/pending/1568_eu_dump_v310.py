...
out["verify"] = {
  ...
  "ai_conf": ai.get("confidence_note"), "ai_raw_head": ai.get("raw_head"),
  "deployed_version_ok": d.get("version")=="3.1.0"}
open("aws/ops/reports/1568_eu_dump_v310.json","w").write(json.dumps(out,indent=2,default=str))

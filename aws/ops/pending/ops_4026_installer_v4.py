"""ops_4026 — ship the one-click Windows installer + page button."""
import json
import sys
import time
...
def main():
    with report("4026_installer_v4") as rep:
        ...
        checks = [("installer publicly downloadable", got == body),
                  ("stub fetches the ps1; logic is caret-free and byte-exact",
                   ...
                   b"Load unpacked" in got1 and b"chrome://extensions" in got1 and b"load-extension" not in got1 and b"^" not in got1
                   and got1 == ps1)]
        n, htm = 0, ""

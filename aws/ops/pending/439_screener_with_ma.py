#!/usr/bin/env python3
"""Step 439 — Fire screener async with new M&A integration. Verify after."""
import io, json, os, time, zipfile
from datetime import datetime, timezone
import boto3

REPORT = "aws/ops/reports/439_screener_with_ma.json"
...
def main():
    ...
    zb = buf.getvalue()
    # Wait for deploy-lambdas to publish screener
    print("Waiting 90s for deploy-lambdas...")
    time.sleep(90)
    try:

"""ops 3623 (regate: ticker->industry via universe) — WIRING SWEEP (Khalid: wire the huge improvements into the
...
with report("3623_wiring3") as rep:
    ...
    Path("aws/ops/reports/3623.json").write_text(json.dumps(out, indent=2, default=str))
    sys.exit(0)

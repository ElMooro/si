...
Either way the desk section runs and v2.3.1's wires get their verdict.
"""
import io
import json
import subprocess
...
fails = []
with report("4300_wave2_sealed") as r:
    r.heading("ops 4300 -- deployed-bytes verdict + independent desk "
              "gate")
    ...
    r.section("B. desk v2.3.1 wires -- independent verdict")

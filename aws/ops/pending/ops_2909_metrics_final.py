"""ops 2909 — final ka/khalid healing proof: wait deploy, fire scheduled Events, poll ages, success tail."""
...
R={"ops":2909,"ts":datetime.now(timezone.utc).isoformat()}
...
os.makedirs("aws/ops/reports",exist_ok=True); json.dump(R,open("aws/ops/reports/2909_metrics_final.json","w"),ensure_ascii=False,indent=1,default=str)
print("OPS 2909 COMPLETE")

"""
ops_4021 — ship v1.5.0: rebuild the zip Khalid downloads, settle the
...
def main():
    with report("4021_ship_v160") as rep:
        rep.heading("ops 4016 — extension v1.6.0 + sources persistence")
        checks = []
        ...
        checks.append(("zip carries v1.5.0", man.get("version") == "1.6.0"))

"""ops 3656 — repair-backlog endgame + synthesis: [A] thesis-engine heal
...
with report("3656_stack_close") as rep:
    rep.heading("ops 3656 — thesis heal + stale endgame + synthesis serves")
    out = {"gates": {}}
    fails = []
    Path("aws/ops/reports/3656.json").write_text(json.dumps({"verdict": "STARTED"}))
    ...
    Path("aws/ops/reports/3656.json").write_text(json.dumps(out, indent=2, default=str))
    sys.exit(0)

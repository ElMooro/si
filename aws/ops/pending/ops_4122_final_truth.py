"""ops_4122 — family verify-only: artifact truth or the vault's own logs."""
import json
import sys
...
MARK = "tradingview-vault v3.15.3 ops4121 feed-first"


def main():
    with report("4122_final_truth") as rep:

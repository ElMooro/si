"""
ops_4047 — ship v1.5.0: rebuild the zip Khalid downloads, settle the
...
def main():
    with report("4047_ship_v172") as rep:
        rep.heading("ops 4016 — extension v1.7.2 + sources persistence")
        checks = []
        ...
        checks.append(("zip carries v1.5.0", man.get("version") == "1.7.2"))
        ...
        checks.append(("zip content is FULLY AUTONOMOUS",
                       "jh-harvest" in cjs and "autoStart" in cjs and "Fully automatic" in cjs))

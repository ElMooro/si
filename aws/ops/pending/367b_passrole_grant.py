#!/usr/bin/env python3
"""
Step 367b — Update JustHodlWssBootstrap managed policy with iam:PassRole.

Switching a Lambda's role via UpdateFunctionConfiguration requires the
caller to have iam:PassRole on the target role. The original
JustHodlWssBootstrap policy (365b) didn't include it, so 368's role
swap will fail with AccessDenied without this update.

Idempotent — creates a new policy version and sets it as default.
"""
import json, os
from datetime import datetime, timezone
import boto3

REPORT = "aws/ops/reports/367b_passrole_grant.json"
    ...
    "Statement": [
        ...
        {"Effect": "Allow",
         "Action": ["lambda:UpdateFunctionConfiguration",
                    ...
                    "lambda:GetPolicy", "lambda:GetFunction",

...
R={"ops":4496,"started":datetime.now(timezone.utc).isoformat()}
buf=io.BytesIO()
...
json.dump(R,open("aws/ops/reports/4496_panel.json","w"),indent=1,default=str)
open("aws/ops/reports/4496_panel.md","w").write(f"# ops 4463 — nyfed-full — {R['verdict']}\n")
print(R["verdict"])

"""
ops_4006 — INVOKE-ONLY. Enforce 900/3008, confirm the v1.6 marker is the
...
MARK = "tradingview-vault v3.9.1 ops4006 alias-union"


def main():
    with report("4006_fire_vault_v391") as rep:

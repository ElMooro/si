...
try:
    ...
    print("EXISTS:",cfg["FunctionName"],"| has ANTHROPIC:", "ANTHROPIC_API_KEY" in (cfg.get("Environment",{}).get("Variables",{})))
except Exception as e:
    print("MISSING:",e.__class__.__name__); raise SystemExit

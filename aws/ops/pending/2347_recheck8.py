...
M=["The read — rules-based synthesis","Risk-on drivers","Risk-off drivers","Own — what's leading","Key risk","Cycle trajectory — the clock","deterministic, runs without","trajectorySection","Posture score","Reduce — what's lagging"]

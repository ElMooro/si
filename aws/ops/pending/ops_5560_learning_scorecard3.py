"""ops 5560 -- learning scorecard after the base exam re-grade (robust completion join) and burst 2's verification.
...
def main() -> int:
    ...
    import gear_b as gb
    with report("ops_5560_learning_scorecard3") as R:
        R.heading("ops 5560 -- learning scorecard: supply (rows/receipts) vs learning (exam delta), from objects only")

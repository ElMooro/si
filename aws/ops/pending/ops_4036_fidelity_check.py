"""ops_4036 — FULL CHECK v2: everything from 4034 PLUS note-fidelity —
...
def main():
    with report("4036_fidelity_check") as rep:
        ...
        pool = [(s2, n2) for s2, ns in tagged.items()
                if ns and s2 in in_wl_keys for n2 in ns]
        random.seed(4036)

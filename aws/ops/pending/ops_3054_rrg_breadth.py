#!/usr/bin/env python3
"""ops 3054 -- ARC A of Khalid's 17-item IR upgrade (items 1+2+3):
    ...
    with report("3054_rrg_breadth") as rep:
        ...
        try:
            ...
            req = urllib.request.Request(
                ...
                % time.time(),
                headers={"User-Agent": "Mozilla/5.0 ops-3054"})
...
def _fin(rep, fails, warns):
    (AWS_DIR / "ops" / "reports" / "3054.json").write_text(json.dumps(
        {"ops": 3054, "verdict": "FAIL" if fails else "PASS",

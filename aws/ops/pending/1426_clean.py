"""ONE clean pass: garble-filter + dedup the whole 43k index via the build route,
walking offset to completion across multiple Lambda invocations. From AWS."""
...
open("aws/ops/reports/1426_c.json","w").write(json.dumps(out,indent=2,default=str)); print("done")

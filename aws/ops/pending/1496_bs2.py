...
lam=boto3.client("lambda",region_name="us-east-1",config=Config(read_timeout=90)); ROLE="arn:aws:iam::857687956942:role/lambda-execution-role"; FN="tmp-bs2"
code=r'''
import json,urllib.request,ssl,boto3
def lambda_handler(e,c):
    ...
    cands={
      "BSI_total_assets_M":"BSI/M.U2.N.C.T00.A.1.Z5.0000.Z01.E",
      "ILM_T000000_A":"ILM/W.U2.C.T000000.U2.EUR",
      "ILM_T000000_Z01A":"ILM/W.U2.C.T000000.U2.Z01.A",
    }
    out={}
    ...
    try:
        ...
        out["ecb_detail_sources"]=d.get("sources")
...
open("aws/ops/reports/1496_bs.json","w").write(json.dumps(out,indent=2,default=str)); print("done")

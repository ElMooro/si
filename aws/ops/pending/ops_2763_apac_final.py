"""ops 2763 — APAC radar FINAL: JP + HK + KR-marketwide all live, page verified.
...
R = {"ops": 2763, "ts": datetime.now(timezone.utc).isoformat()}
def zip_fn(fn):
...
json.dump(R, open("aws/ops/reports/2763_apac_final.json", "w"), indent=1, ensure_ascii=False, default=str)
print("OPS 2763 COMPLETE — APAC radar: 4 markets (TW/KR/JP/HK) + US bridges, all real")

"""ops 3644 (recalibrate regate) — NEW justhodl-geopolitical-risk engine (World Monitor-inspired,
...
with report("3644_geo_recal") as rep:
    rep.heading("ops 3644 (recalibrate regate) — geopolitical-risk engine (news-flow country stress)")
    out = {"gates": {}}
    fails = []
    ...
    Path("aws/ops/reports/3644.json").write_text(json.dumps(out, indent=2, default=str))
    sys.exit(0)

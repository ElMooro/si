...
def main() -> int:
    ...
    with report("ops_5530_own_training_lane_rearm2") as R:
        R.heading("ops 5530 (re-arm of 5528/5529) -- owned training lane: ECR repo, pinned recipe bundle, base-weight staging job (CPU, priced), no flip")
        R.kv(head=head[:10])

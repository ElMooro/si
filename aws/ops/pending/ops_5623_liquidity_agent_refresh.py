...
COMMIT = "87c9822ae5e2107f690f2750ec073aab0d220b86"
...
def main():
    ...
    with report("ops_5623_liquidity_agent_refresh") as r:
        ...
        assert feed.get("meta", {}).get("agent_version") == "2.1.0", "Unexpected engine version"

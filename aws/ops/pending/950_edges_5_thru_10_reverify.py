...
Output: aws/ops/reports/950_edges_5_thru_10_reverify.json
"""
...
EDGES = [
    {
        "edge": 5, "engine": "russell-recon", "lambda": "justhodl-russell-recon",
        "s3_key": "data/russell-recon.json", "page": "russell-recon.html",
        "ssm_key": "/justhodl/russell-recon/state",
        "valid_states": ("QUIET", "PRE_RECON_BUILDUP", "EFFECTIVE_DAY",
                         "POST_RECON_REVERSAL", "ADDS_PHASE", "DELETES_PHASE"),
        "extra_required": ["next_recon_date", "days_to_recon"],
    },
    {
        "edge": 6, "engine": "buyback-scanner", "lambda": "justhodl-buyback-scanner",
        "s3_key": "data/buyback-scanner.json", "page": "buyback-scanner.html",
        "ssm_key": "/justhodl/buyback-scanner/state",
        "valid_states": ("LOW_ACTIVITY", "NORMAL", "ELEVATED",
                         "WAVE", "MEGA_AUTH_DETECTED"),
        "extra_required": ["recent_authorizations", "total_authorized_usd_30d"],
    },
    {
        "edge": 7, "engine": "stablecoin-flow", "lambda": "justhodl-stablecoin-flow",
        "s3_key": "data/stablecoin-flow.json", "page": "stablecoin-flow.html",
        "ssm_key": "/justhodl/stablecoin-flow/state",
        "valid_states": ("CONTRACTING", "NEUTRAL", "EXPANDING",
                         "ACCELERATING", "BLOWOUT"),
        "extra_required": ["net_flow_7d_usd", "total_supply_usd"],
    },
    {
        "edge": 8, "engine": "opex-calendar", "lambda": "justhodl-opex-calendar",
        "s3_key": "data/opex-calendar.json", "page": "opex-calendar.html",
        "ssm_key": "/justhodl/opex-calendar/state",
        "valid_states": ("QUIET", "BUILDUP", "OPEX_WEEK",
                         "OPEX_DAY", "POST_OPEX", "QUAD_WITCHING"),
        "extra_required": ["days_to_next_opex", "max_pain", "dealer_gex_proxy"],
    },
    {
        "edge": 9, "engine": "activist-13d", "lambda": "justhodl-activist-13d",
        "s3_key": "data/activist-13d.json", "page": "activist-13d.html",
        "ssm_key": "/justhodl/activist-13d/state",
        "valid_states": ("QUIET", "NEW_FILING", "MULTI_ACTIVIST",
                         "TIER_A_HOT", "WAVE"),
        "extra_required": ["recent_filings"],
    },
    {
...
def verify_edge(cfg):
    ...
    # 6. State enum
    add(e, "state_valid",
        d.get("state") in cfg["valid_states"],
        f"got={d.get('state')} valid={cfg['valid_states']}")
    ...
    try:
        ...
        add(e, "data_recent_48h", age_h <= 48,
            f"as_of={d['as_of']} age_hours={round(age_h, 1)}")
    except Exception as ex:
...
def main():
    ...
    with open("aws/ops/reports/950_edges_5_thru_10_reverify.json", "w") as f:

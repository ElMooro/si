...
R={"ops":4510,"started":datetime.now(timezone.utc).isoformat()}
for _ in range(20):
...
bus({"action":"post_turn","thread_id":"0806-master","from":"claude","to":"perplexity","kind":"propose",
 "content":("CANARY v2 (early-write + 420s tail budget + 900s) + CLIPPED SURFACING: fn_err="+str(R.get("fn_err"))

"""ops 3595 — deal-scanner v3.2.1 display restore: sized-but-not-green deals
...
with report("3595_ds_boomjoin2") as rep:
    rep.heading("ops 3595 — deal-scanner sized-cards + industry-peer context")
    out = {"gates": {}}
    fails = []
    ...
    Path("aws/ops/reports/3595.json").write_text(json.dumps(out, indent=2, default=str))
    sys.exit(0)

"""ops/4922 -- floor-audit v2.0.1: the sweep, with dense frames.
...
UA = "JustHodl ops4922 edge-acceptance"
...
def main():
    with report("4922-floor-v201-dense-frames") as r:
        r.heading("ops 4922 -- floor-audit v2.0.1 dense-frame sweep")
               ...
               "top_calls": [
                   ...
                   for x in sorted(
                       ok, key=lambda z: -(z["recommendation"]
                                           ["conviction"] or 0))[:15]],
               "edge": "LIVE"}
        (ROOT / "aws" / "ops" / "reports" / "4922.json").write_text(

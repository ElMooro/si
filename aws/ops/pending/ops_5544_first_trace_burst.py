...
def main() -> int:
    ...
    with report("ops_5544_first_trace_burst") as R:
        R.heading("ops 5544 -- first owned trace burst: prompts-only tasks, runner rights, live price, spot job on the digest-pinned image")
        R.kv(head=head[:10])

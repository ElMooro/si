#!/usr/bin/env python3
"""ops 2954 — dollar v2 second pass: redeploy with the TGA units fix ($mn ->
...
def main():
    with report("2954_dollar_v2_final") as rep:
        fails = []
        ...
        deploy_lambda(report=rep, function_name="justhodl-dollar-radar",
                      ...
                      description="dollar v2.1: self-discovering china+cftc probes (ops 2954)",
                      smoke=True)

"""ops_4025 — ship the one-click Windows installer + page button."""
import json
import sys
import time
...
def main():
    with report("4025_installer_v3") as rep:
        ...
        checks = [("installer publicly downloadable", got == body),
                  ("stub fetches the ps1; logic is caret-free and byte-exact",
                   ...
                   b"Shortcut written to" in got1 and b"Start-Process" in got1 and b"load-extension" in got1 and b"^" not in got1
                   and got1 == ps1)]
        n, htm = 0, ""

...
def pick(k):
    e=ev_.get(k) or {}
    return {"touches":e.get("touch_n"),"t21":(e.get("touch") or {}).get(21),
            "shelf":e.get("shelf_depth_med_pct"),
            "bd_n":e.get("breakdown_n"),"bd21":(e.get("breakdown") or {}).get(21)}
...
open("aws/ops/reports/1583_ma_reversion.json","w").write(json.dumps(out,indent=2,default=str))

"""
ops 3727 — readthrough.html: surface the engine fields the page never showed
...
def main():
    with report("3727_readthrough_verify") as rep:
        rep.heading("ops 3727 — readthrough.html: surface the hidden engine fields")
        fails = []
        out = {}

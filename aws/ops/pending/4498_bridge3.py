...
R={"ops":4498,"started":datetime.now(timezone.utc).isoformat()}
buf=io.BytesIO()
...
json.dump(R,open("aws/ops/reports/4498_bridge3.json","w"),indent=1,default=str)
open("aws/ops/reports/4498_bridge3.md","w").write(f"# ops 4463 — nyfed-full — {R['verdict']}\n")
print(R["verdict"])

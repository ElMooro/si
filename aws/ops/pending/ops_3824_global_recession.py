"""
ops_3824 — justhodl-global-recession v1.0.0 + chokepoint day-two re-read
...
def main():
    with report("3824_global_recession") as rep:
        rep.heading("ops 3824 — v1.1 recalibration: global recession ensemble + chokepoint day-two")

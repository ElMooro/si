...
def main():
    ...
    with report('ops_5834_inflection_research_acceptance') as r:
        ...
        while len(runtimes)!=len(names):
            for fn in names:
                ...
                if receipt is None or receipt.get('commit')!=expected:continue
        ...
        proof={'contract':'liquidity-inflection-verification.v1','generated_at':datetime.now(timezone.utc).isoformat(),
            ...
            'original_replay_reproduced':True,'component_changes_reconciled':True,'calls_eligible':False,'sizing_eligible':False,

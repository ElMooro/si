"""
ops_3963 — SELF-HEAL DEPLOY of justhodl-domain-barometers.
...
def main():
    with report("3963_barometers_selfheal") as rep:
        ...
        r = lam.invoke(FunctionName=FN, InvocationType="RequestResponse",
                       Payload=json.dumps({"source": "ops3963"}).encode())
        ...
        checks += [
            ...
            (">=90% from his own notes", (ca.get("from_his_own_notes_pct") or 0) >= 90),

...
BATCH = 'chatgpt-20260917T233902Z-auction-pd-context'
...
def main():
    ...
    with report('ops_5706_auction_pd_verify') as r:
        ...
        tail=doc['tail_risk']
        assert tail['p_failed_auction_30d']['alias_of']=='p_soft_demand_30d'
        assert tail['p_failed_auction_30d']['heuristic_score']==tail['p_soft_demand_30d']['heuristic_score']

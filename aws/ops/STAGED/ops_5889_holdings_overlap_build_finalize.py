"""Verify the existing overlap snapshot and an unchanged scheduled Pages rebuild."""
import sys
from ops_5887_holdings_overlap_acceptance import main

if __name__ == '__main__':
    try:
        main(report_name='ops_5889_holdings_overlap_build_finalize',
        ...
        print('Overlap build finalization failed. No engine was invoked; inspect the committed report.')
        sys.exit(1)

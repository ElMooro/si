...
ASSETS={'market-internals.html': 'ac48b95678154c962dfd819939b90b7116df8f22f130606d606d2bcd08792686', 'jh-breadth-research.js': 'f5e24d3592aed75fa81248e2b3fe8feec47a085a2ad1125872ced2b23ab8c221'}
...
def main():
    with report('ops_5925_breadth_scope_closure_acceptance') as r:
        ...
        proof={'contract':'breadth-scope-closure-acceptance.v1','verified_at':datetime.now(timezone.utc).isoformat(),
            'consumer_commit':COMMIT,'runtimes':runtimes,'pages_commit':pages_commit,'assets':ASSETS,

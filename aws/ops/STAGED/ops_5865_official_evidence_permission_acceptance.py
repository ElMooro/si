...
def main():
    expected=subprocess.check_output(['git','log','-1','--format=%H','--','aws/lambdas/justhodl-official-pulse'],text=True).strip()
    ...
    with report('ops_5865_official_evidence_permission_acceptance') as r:
        ...
        assert output['dollar_leg']['tic_context']['source_status']=='immutable_descriptive_context' and output['dollar_leg']['tic_context']['status']=='MONITOR_ONLY'

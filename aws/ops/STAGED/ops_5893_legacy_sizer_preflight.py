"""Inspect the public legacy sizer and retain its complete preceding publication."""
...
def main():
    ...
    def raw(key):
        ...
        return value
    with report('ops_5893_legacy_sizer_preflight') as r:
        ...
        preserved = []
        for key in ('data/position-sizing.json',):
            ...
            private = 'audit-private/20260909-originals/legacy-public-sizer/'+sha+'.bin'
...
if __name__ == '__main__':
    try: main()
        ...
        print('Legacy public sizer preflight failed; inspect the committed report before changing production.')
        sys.exit(1)

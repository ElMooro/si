...
def main():
    ...
    with report('ops_5920_domain_monitor_publication_acceptance') as r:
        ...
        proof={'contract':'domain-monitor-verification.v1','generated_at':datetime.now(timezone.utc).isoformat(),
            ...
            'public_generated_at':stamp,'public_packet_sha256':sha(public('data/domain-barometers.json')),'trigger_identity_verified':False,'publication_acceptance':'observed_new_contract' if qualified else 'awaiting_natural_publication',

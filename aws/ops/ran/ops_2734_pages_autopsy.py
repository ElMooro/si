"""ops 2734 — PAGES DEPLOY ROOT CAUSE (two vectors, auth-redirect fixed).
...
Report: aws/ops/reports/2734_pages_autopsy.json.
"""
...
R = {"ops": 2734, "ts": datetime.now(timezone.utc).isoformat()}
...
with open("aws/ops/reports/2734_pages_autopsy.json", "w") as f:
...
print("OPS 2734 COMPLETE — root cause captured")

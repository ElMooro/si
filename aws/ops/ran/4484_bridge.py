...
R={"ops":4484,"started":datetime.now(timezone.utc).isoformat()}
buf=io.BytesIO()
...
json.dump(R,open("aws/ops/reports/4484_bridge.json","w"),indent=1,default=str)
open("aws/ops/reports/4484_bridge.md","w").write(f"# ops 4463 — nyfed-full — {R['verdict']}\n")
print(R["verdict"])

"""
ops/844 - justhodl-firm-book deploy + end-to-end verification.
...
Writes aws/ops/reports/844_firm_book_deploy.json.
"""
import io
import json
import time
...
rep = {
    ...
    "subject": "Deploy + verify justhodl-firm-book (consolidated "
...
print(out)
try:
    with open("aws/ops/reports/844_firm_book_deploy.json", "w") as f:
        f.write(out)
except Exception as e:

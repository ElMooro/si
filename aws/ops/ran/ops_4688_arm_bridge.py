"""ops 4688 — arm the browser grabber + publish it ready-to-paste.
...
def main():
    with report("4688_arm_grabber") as r:
        r.heading("ops 4688 — re-arm grabber v2 (chart-independent)")
        misses = 0
        ...
        # 4688 rev: /justhodl/tvnotes/ingest-url does not exist —

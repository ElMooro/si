"""Retry the complete core release after correcting configuration metadata and JSON environment inheritance. No AWS API calls."""
...
REPORT = ROOT / "aws/ops/reports/latest/ops_5237_core_recovery_dispatch.json"
...
def main():
    ...
    report = {"operation": "5237", "workflow": WORKFLOW, "workflow_sha": commit, "base_sha": BASE_SHA,
...
if __name__ == "__main__":
    ...
    with ops_report("ops_5237_retry_pinned_core_release") as rep:
        try:
            main()

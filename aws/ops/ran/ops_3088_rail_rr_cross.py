...
UA = {"User-Agent": "Mozilla/5.0 ops-3088",
...
def main():
    ...
    with report("3088_rail_rr_cross") as rep:
...
def _fin(rep, fails, warns):
    (AWS_DIR / "ops" / "reports" / "3088.json").write_text(json.dumps(
        {"ops": 3088, "verdict": "FAIL" if fails else "PASS",

"""ops_4158 — coverage triple-round: symbol-feed v1.2 (indices, futures,
...
def main():
    with report("4158_triple_round") as rep:
        ...
        checks.append(("targets >= 1900 (new classes admitted)",
                       (fd.get("targets") or 0) >= 1900))
        checks.append(("resolved >= 550",
                       (fd.get("resolved") or 0) >= 550))
        p = fd.get("prices") or {}

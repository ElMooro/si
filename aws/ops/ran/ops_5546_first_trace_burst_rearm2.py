...
def main() -> int:
    ...
    with report("ops_5546_first_trace_burst_rearm2") as R:
        R.heading("ops 5546 (re-arm of 5545) -- first owned trace burst: prompts-only tasks, runner rights, live price, spot job on the digest-pinned image")
        R.kv(head=head[:10])

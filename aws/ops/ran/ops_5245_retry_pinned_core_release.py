"""Queue the dated-correlation sizing follow-up after the running recovery batch. No AWS API calls."""
...
BASE_SHA = "76e1bc19c8227f37e7ee3a63ac3290a2ba37476f"
WORKFLOW = "deploy-lambdas.yml"
REPORT = ROOT / "aws/ops/reports/latest/ops_5245_core_recovery_dispatch.json"
...
def main():
    ...
    report = {"operation": "5245", "workflow": WORKFLOW, "workflow_sha": commit, "base_sha": BASE_SHA,
...
if __name__ == "__main__":
    ...
    with ops_report("ops_5245_retry_pinned_core_release") as rep:
        try:
            main()

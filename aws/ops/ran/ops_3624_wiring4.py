"""ops 3624 (universe stocks-key hotfix regate) — WIRING SWEEP (Khalid: wire the huge improvements into the
...
with report("3624_wiring4") as rep:
    ...
    Path("aws/ops/reports/3624.json").write_text(json.dumps(out, indent=2, default=str))
    sys.exit(0)

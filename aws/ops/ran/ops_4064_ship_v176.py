"""
ops_4064 — ship v1.5.0: rebuild the zip Khalid downloads, settle the
...
def main():
    with report("4064_ship_v176") as rep:
        rep.heading("ops 4016 — extension v1.7.6 + sources persistence")
        checks = []
        ...
        checks.append(("zip carries v1.5.0", man.get("version") == "1.7.6"))
        ...
        checks.append(("zip content is FULLY AUTONOMOUS",
                       "ssfetch" in cjs and "purged" in cjs))

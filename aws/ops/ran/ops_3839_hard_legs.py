"""
ops_3839 — justhodl-global-recession v1.0.0 + chokepoint day-two re-read
...
def main():
    with report("3839_hard_legs") as rep:
        rep.heading("ops 3839 — v1.3 hard legs (port throughput + credit impulse): global recession ensemble + chokepoint day-two")
        ...
        hard = [c for c in cs if "physical" in
                ...
                json.dumps(c.get("confirmation_detail") or {}).lower()]
        chk("at least 3 countries on a hard leg", len(hard) >= 3,

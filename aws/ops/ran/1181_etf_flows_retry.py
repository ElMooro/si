...
REPORT = "aws/ops/reports/1181_etf_flows_retry.json"
...
if not lambda_exists:
    ...
    try:
        ...
        resp = lam.create_function(
            ...
            Description="ETF Capital Flow Intelligence. Daily 80+ ETF flows + z-scores + 6 composite signals (defensive_rotation, smart_vs_dumb, risk_on_off, domestic_vs_intl, growth_vs_value, credit_stress) + regime classifier. Writes etf-flows/* outputs.",
            Timeout=300,
            MemorySize=1024,

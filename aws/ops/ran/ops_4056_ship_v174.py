"""
ops_4056 — ship v1.5.0: rebuild the zip Khalid downloads, settle the
...
def main():
    with report("4056_ship_v174") as rep:
        rep.heading("ops 4016 — extension v1.7.4 + sources persistence")
        checks = []
        ...
        checks.append(("zip carries v1.5.0", man.get("version") == "1.7.4"))
        ...
        checks.append(("zip content is FULLY AUTONOMOUS",
                       "!DIAG.total" in cjs and "contentHarvest" in cjs))

...
def main():
    expected=subprocess.check_output(['git','log','-1','--format=%H','--','aws/ops/pending/ops_5738_ciss_consumers_reverify.py'],text=True).strip()
    ...
    with report('ops_5738_ciss_consumers_reverify') as r:

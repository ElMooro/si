"""
ops/852 - justhodl-merger-arb-risk RE-DEPLOY (sign-model fix) + verify.
...
Writes aws/ops/reports/852_merger_arb_risk_redeploy.json.
"""
import io
import json
import time
...
rep = {
    ...
    "subject": "Re-deploy + verify justhodl-merger-arb-risk (the Merger-Arb "
...
print(out)
try:
    with open("aws/ops/reports/852_merger_arb_risk_redeploy.json", "w") as f:
        f.write(out)
except Exception as e:

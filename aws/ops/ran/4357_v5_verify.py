"""ops 4357 — verify crypto-intel v5.0 end-to-end.
...
Report -> aws/ops/reports/4357_v5_verify.{json,md}
"""
import json, os, time
...
R = {"ops": 4357, "started": datetime.now(timezone.utc).isoformat(), "attempts": []}
doc = None
for i in range(8):
...
with open("aws/ops/reports/4357_v5_verify.json", "w") as f:
    json.dump(R, f, indent=1, default=str)
v = R.get("verify", {})
md = [f"# ops 4357 — crypto-intel v5 verify — {R['verdict']}",
...
with open("aws/ops/reports/4357_v5_verify.md", "w") as f:
    f.write("\n".join(md) + "\n")

...
R={"ops":4478,"started":datetime.now(timezone.utc).isoformat()}
def wait_idle():
    for _ in range(24):
...
json.dump(R,open("aws/ops/reports/4478_golden2.json","w"),indent=1,default=str)
open("aws/ops/reports/4478_golden2.md","w").write(f"# ops 4477 — golden copy — {R['verdict']}\n")
print(R["verdict"])

"""ops 3539 — institutional layer 2 (the "what else would a hedge fund
...
with report("3539_institutional_l2") as rep:
    fails = []
    def gate(n, ok, d):
    ...
    rep.heading("ops 3539 — factors + joins + saved screens")
    try:
    ...
    deploy_lambda(report=rep, function_name=FN,
                  ...
                  description="Census v1.6.0 factors+joins (ops 3539)",
    ...
    (REPO/"aws/ops/reports/3539.json").write_text(
        json.dumps({"ops": 3539, "fails": fails}))
sys.exit(0)

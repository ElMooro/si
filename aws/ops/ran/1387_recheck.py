...
ROLE="arn:aws:iam::857687956942:role/lambda-execution-role"; FN="tmp-bd2"
code='''
...
open("aws/ops/reports/1387_r.json","w").write(json.dumps(out,indent=2,default=str)); print("done")

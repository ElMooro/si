...
ROLE="arn:aws:iam::857687956942:role/lambda-execution-role"; FN="tmp-nk"
code=r'''
...
def lambda_handler(e,c):
    ...
    out["t0"]=call("/brain-purge?uid="+NK+"&token="+T+"&max=1&offset=0").get("total_now")
    time.sleep(95)
    out["t95"]=call("/brain-purge?uid="+NK+"&token="+T+"&max=1&offset=0").get("total_now")
    return out
'''
buf=io.BytesIO()
...
open("aws/ops/reports/1434_nk.json","w").write(json.dumps(out,indent=2,default=str)); print("done")

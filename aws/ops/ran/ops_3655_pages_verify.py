"""ops 3655 — dedicated pages + sidebar for the geo-intel stack: geo-risk.html
...
with report("3655_pages_verify") as rep:
    rep.heading("ops 3655 — geo-stack dedicated pages + sidebar")
    out = {"gates": {}}
    fails = []
    Path("aws/ops/reports/3655.json").write_text(json.dumps({"verdict": "STARTED"}))
    ...
    Path("aws/ops/reports/3655.json").write_text(json.dumps(out, indent=2))
    sys.exit(0)

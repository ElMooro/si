#!/usr/bin/env python3
"""ops 3774 — prove capture-gap.html is SERVED (edge), not merely committed.
...
def main():
    with report("3774_verify_served_v2") as rep:
        rep.heading("ops 3774 — edge verification of capture-gap.html")

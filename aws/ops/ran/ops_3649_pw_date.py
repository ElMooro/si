"""ops 3649 — NEW justhodl-portwatch (IMF PortWatch chokepoints, discovered
...
with report("3649_pw_date") as rep:
    rep.heading("ops 3649 — IMF PortWatch chokepoint engine")
    out = {"gates": {}, "catalog": {
    ...
    try:
        deploy_lambda(report=rep, function_name=FN,
                      ...
                      description="portwatch v1.0.2 (string-date tolerant): IMF chokepoint transits, z + disruption flags"[:200],
    ...
    Path("aws/ops/reports/3649.json").write_text(json.dumps(out, indent=2, default=str))
    sys.exit(0)

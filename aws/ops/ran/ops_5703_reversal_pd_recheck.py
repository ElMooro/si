...
KEY = 'data/liquidity-reversal.json'
BATCH = 'chatgpt-20260917T232148Z-reversal-stamp-pd-context'
...
def main():
    ...
    with report('ops_5703_reversal_pd_recheck') as r:
        ...
        # Ops 5701 invoked successfully; its only failed assertion compared a
        # seconds-precision output to a microseconds-precision start time.
        # Verify that already observed refreshed output; do not rerun a 3m crawl.
        started=datetime(2026,9,17,23,23,42,tzinfo=timezone.utc)
        ...
        r.ok('Rechecked ops 5701 refreshed output with seconds-precision timestamp, exact receipt, AWS/source hashes and both canonical scopes')

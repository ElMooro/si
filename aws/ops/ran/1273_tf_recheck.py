...
try:
    ...
    out["sample"]=[{"t":e["ticker"],"aum":e.get("aum_est_b"),"nf1":e.get("net_flow_1d_usd")} for e in list(tf.get("by_etf",{}).values())[:6]]
except Exception as e: out["err"]=str(e)[:150]
open("aws/ops/reports/1273_tf.json","w").write(json.dumps(out,indent=2,default=str)); print("done")

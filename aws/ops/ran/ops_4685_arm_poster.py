"""ops 4685 — arm the browser grabber + publish it ready-to-paste.
...
def main():
    with report("4685_arm_grabber") as r:
        r.heading("ops 4685 — re-arm grabber v2 (chart-independent)")
        misses = 0
        ...
        # 4685 rev: /justhodl/tvnotes/ingest-url does not exist —

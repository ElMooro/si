"""
ops_4010 — INVOKE-ONLY. Enforce 900/3008, confirm the v1.6 marker is the
...
MARK = "tradingview-vault v3.10 ops4010 boj-and-six"


def main():
    with report("4010_fire_vault_v310") as rep:

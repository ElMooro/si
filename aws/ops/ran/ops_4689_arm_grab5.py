"""ops 4689 — arm the browser grabber + publish it ready-to-paste.
...
def main():
    with report("4689_arm_grabber") as r:
        r.heading("ops 4689 — re-arm grabber v2 (chart-independent)")
        misses = 0
        ...
        # 4689 rev: /justhodl/tvnotes/ingest-url does not exist —

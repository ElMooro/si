"""ops 3446 — creative #6: cannibals family live. Gates: settle+schedule
...
with report("3447_cannibals") as rep:
    rep.heading("ops 3446 — cannibals family")
    out={"gates":{}}; fails=[]
    def gate(n,ok,d):
    ...
    r=LAM.invoke(FunctionName="justhodl-cannibals",InvocationType="RequestResponse",Payload=b"{}")
    ...
    Path("aws/ops/reports/3447.json").write_text(json.dumps(out,indent=2,default=str)); sys.exit(0)

"""ops_5206 -- KATLIN v1.2.0 verify (washout gate, structural plans, PortWatch bind, reweight): redeploy from the runner, async run + freshness gate, war-room read, tiers, joins,
...
with report("ops_5206_katlin_v120_verify") as R:
    R.heading("ops 5206 -- KATLIN v1.2.0 verify")

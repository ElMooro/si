"""ops_4146 — loud vault settle for v3.19.0 + async fire + gates on the
...
MARK = "tradingview-vault v3.19.0 ops4145 mfs-families"


def main():
    with report("4146_vault_settle_gates") as rep:
        ...
        for sym, lo in (("JPLG", 1e14), ("BRCBBS", 1e11),
                        ("JPM0", 1e14)):

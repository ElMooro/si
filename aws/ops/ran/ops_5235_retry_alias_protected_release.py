"""Retry the complete core release after fixing alias-protection revision handling. No AWS API calls."""
...
REPORT = ROOT / "aws/ops/reports/latest/ops_5235_core_recovery_dispatch.json"
...
def main():
    ...
    report = {"operation": "5235", "workflow": WORKFLOW, "workflow_sha": commit, "base_sha": BASE_SHA,
...
if __name__ == "__main__":
    ...
    with ops_report("ops_5235_retry_alias_protected_release") as rep:
        try:
            main()

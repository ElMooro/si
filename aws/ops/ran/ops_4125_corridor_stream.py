"""ops_4125 — streaming phase timeline: settle v3.15.4, invoke, watch the
...
MARK = "tradingview-vault v3.15.5 ops4125 corridor"


def main():
    with report("4125_corridor_stream") as rep:

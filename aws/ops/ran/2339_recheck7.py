...
M=["Implied Fed path","Futures (COT)","Stress scenarios & tail risk","System tail gauge","Scenario tree","Probability-weighted asset impact","Euro-area systemic","next FOMC","Correlation regime","Tail risk"]

"""ops 4687 — arm the browser grabber + publish it ready-to-paste.
...
def main():
    with report("4687_arm_grabber") as r:
        r.heading("ops 4687 — re-arm grabber v2 (chart-independent)")
        misses = 0
        ...
        # 4687 rev: /justhodl/tvnotes/ingest-url does not exist —
        ...
        js = open("tools/ice-recover.html").read()

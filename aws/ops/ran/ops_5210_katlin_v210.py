"""ops_5210 -- KATLIN v2.1.0: tighter CONFIRMED structure (real chain, margins, prior decline), history gate on PRIME/READY,
...
with report("ops_5210_katlin_v210") as R:
    R.heading("ops 5210 -- KATLIN v2.1.0")
        ...
        with sync_playwright() as p:
            ...
            for width, height in ((1440, 1100), (390, 844)):
                ...
                facts = pg.evaluate("""() => ({ score: document.getElementById('wr-score').textContent, posture: document.getElementById('wr-posture').textContent,
                    ...
                    valextra: document.querySelectorAll('#val-extra table tbody tr').length, hist: (document.getElementById('wr-brief').textContent.indexOf('In this regime') >= 0),

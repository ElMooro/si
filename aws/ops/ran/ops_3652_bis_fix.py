"""ops 3652 — NEW justhodl-bis-crossborder (BIS WS_CBS_PUB foreign claims,
...
with report("3652_bis_fix") as rep:
    rep.heading("ops 3652 — BIS cross-border claims engine + plumbing wire")
    out = {"gates": {}}
    fails = []
    ...
    Path("aws/ops/reports/3652.json").write_text(json.dumps(out, indent=2, default=str))
    sys.exit(0)

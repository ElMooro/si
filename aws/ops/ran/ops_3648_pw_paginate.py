"""ops 3648 — NEW justhodl-portwatch (IMF PortWatch chokepoints, discovered
...
with report("3648_pw_paginate") as rep:
    rep.heading("ops 3648 — IMF PortWatch chokepoint engine")
    out = {"gates": {}, "catalog": {
    ...
    try:
        deploy_lambda(report=rep, function_name=FN,
                      ...
                      description="portwatch v1.0.1 (1000-cap pagination): IMF chokepoint transits, z + disruption flags"[:200],
    ...
    Path("aws/ops/reports/3648.json").write_text(json.dumps(out, indent=2, default=str))
    sys.exit(0)

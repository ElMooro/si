"""
ops_4045 — ship v1.5.0: rebuild the zip Khalid downloads, settle the
...
def main():
    with report("4045_ship_v171") as rep:
        rep.heading("ops 4016 — extension v1.7.1 + sources persistence")
        checks = []
        ...
        checks.append(("zip carries v1.5.0", man.get("version") == "1.7.1"))
        ...
        checks.append(("zip content is FULLY AUTONOMOUS",
                       "autoStart" in cjs and "AUTO_TRIES" in cjs and "autoSync" in cjs))

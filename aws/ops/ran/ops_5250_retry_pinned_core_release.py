"""Apply only the Fed active-series, weekly-calendar and metadata-cache follow-up. No AWS API calls."""
...
BASE_SHA = "9e9d103ca8152ac72734ae1d71ef7df887a6e516"
WORKFLOW = "deploy-lambdas.yml"
REPORT = ROOT / "aws/ops/reports/latest/ops_5250_core_recovery_dispatch.json"
...
def main():
    ...
    report = {"operation": "5250", "workflow": WORKFLOW, "workflow_sha": commit, "base_sha": BASE_SHA,
...
if __name__ == "__main__":
    ...
    with ops_report("ops_5250_retry_pinned_core_release") as rep:
        try:
            main()

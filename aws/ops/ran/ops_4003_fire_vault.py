"""
ops_4003 — INVOKE-ONLY. Enforce 900/3008, confirm the v1.6 marker is the
...
MARK = "tradingview-vault v3.9 ops4003 cb-expansion"


def main():
    with report("4003_fire_vault") as rep:

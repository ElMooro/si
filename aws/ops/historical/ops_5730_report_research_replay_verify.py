...
def main():
    ...
    expected=subprocess.check_output(['git','log','-1','--format=%H','--','aws/ops/pending/ops_5730_report_research_replay_verify.py'],text=True).strip()
    ...
    with report('ops_5730_report_research_replay_verify') as r:

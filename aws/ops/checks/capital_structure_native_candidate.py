"""Prepared native Share Flows publisher; not connected to a live Lambda.

Source collection and independent qualification belong to the runner. HTTP
reads cannot generate research; native publication only replays qualified
retained sources. Deployment still requires the real population/runtime test.
"""
import json, re

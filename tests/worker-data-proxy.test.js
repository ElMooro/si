...
test('publication proofs and exact reads bypass cached versions; missing public objects are never negative-cached',async()=>{
  ...
  for(const key of ['data/daily-research-verification.json','data/ops/releases/justhodl-daily-report-v3.json',
      ...
      'data/quantum-desk.json','data/quantum-desk-history.json','data/liquidity-inflection.json','data/liquidity-inflection-decisive-call.json','data/global-liquidity.json','data/global-liquidity-history.json','data/cb-injection.json','data/vintage/_index.json','data/vintage/WTREGEN.json','data/vintage/RRPONTSYD.json','data/some-current.json?exact=1']){

...
class Tests(unittest.TestCase):
    def test_source_mapping_keeps_exact_clocks_and_whole_predecessor(self):
        ...
        source={'sources':{'ES:bars:ESZ6':{'complete':False}},'provider_requests':19,'provider_response_bytes':163680,
        ...
        self.assertEqual(result,{'contract':'futures-original-inputs.v1','generated_at':'calculation-clock','sources':source['sources'],

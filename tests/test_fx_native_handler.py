...
PATH=ROOT/'aws/lambdas/justhodl-polygon-fx-regime/source/lambda_function.py'
spec=importlib.util.spec_from_file_location('fx_native_handler_test',PATH);handler=importlib.util.module_from_spec(spec);spec.loader.exec_module(handler)
...
class Tests(unittest.TestCase):
    ...
    def test_http_only_reads_published_body(self):
        ...
        client.get_object.assert_called_once_with(Bucket='justhodl-dashboard-live',Key='data/fx-quote-research.json');client.put_object.assert_not_called()

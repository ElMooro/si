...
test('history selector has a short explicit label independent of its option text',()=>{assert.match(ui.render(packet()),/<label for="breadth-metric">Measure<\/label><select id="breadth-metric">/);});

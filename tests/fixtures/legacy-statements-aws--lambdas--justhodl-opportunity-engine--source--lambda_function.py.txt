...
def lambda_handler(event, context):
    ...
    out = {
        ...
        "risk_gate": {"posture": risk_gate_snapshot.get("posture"),
                       "sizing_multiplier": risk_gate_snapshot.get("sizing_multiplier"),
                       "sizing_eligible": False, "consume_as": "Research ranking only; Risk Gate grants no sizing authority"},

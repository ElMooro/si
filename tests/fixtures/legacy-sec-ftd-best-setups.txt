...
# ── CENSUS OVERLAY (ops 3550 · BS-CENSUS): conviction / combo / risk / patterns /
...
def lambda_handler(event, context):
    ...
    massive = __import__("massive_research_context").context(read_json("data/massive-signals.json"))

(function(root){'use strict';
 ...
 function safe(key){return typeof key==='string'&&/^data\/(?:extremes|crisis|breadth|credit|volatility|eurodollar|insider|aaii|fails)-research\/(?:runs|outputs)\/[a-f0-9]{64}\.json$/.test(key);}
